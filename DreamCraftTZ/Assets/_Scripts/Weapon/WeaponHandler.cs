...
namespace _Scripts.Weapon
{
    public class WeaponHandler
    {
        ...
        public WeaponHandler(Transform player, float weaponDistanceFromPlayer,GameSettings.GameSettings gameSettings,SpriteRenderer weapon)
        {
            Weapon = weapon;
        ...
        {
            return (Utilities.Utilities.GetWorldMousePosition() - _player.position).normalized;
        }
    }
}